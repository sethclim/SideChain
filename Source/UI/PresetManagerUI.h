...
class PresetPanel : public Component, Button::Listener, ComboBox::Listener, ValueTree::Listener
{

public:
	PresetPanel(Service::PresetManager &pm, juce::AudioProcessorValueTreeState &apvts) : presetManager(pm)
	{
...
private:
	...
	void loadPresetList()
	{
		...
		DBG("loadPresetList " + currentPreset);
